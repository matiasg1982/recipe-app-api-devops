...
data "template_file" "api_container_definitios" {
...
resource "aws_ecs_task_definition" "api" {
  ...
  container_definitions    = data.template_file.api_container_definitios.rendered
...
resource "aws_iam_policy" "ecs_s3_access" {
  ...
  path        = "/"
  description = "Allow policy to S3 app buckket"
